...
* **Sincronização Automatizada**: API integrada com o n8n para atualizar automaticamente o volume trimestral médio resoluto e gerenciar o ciclo de vida dos agentes (entradas, saídas e desligamentos) direto no banco de dados.
...
* **Integração de Dados**: n8n (Integração e consumo da Freshchat API para estatísticas e gestão de agentes ativos).
