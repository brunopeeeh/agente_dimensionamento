...
export const getAutoTurnoverMonths = (
  _period: PlannerInputs["turnoverPeriod"],
  timeline: MonthPoint[],
): string[] => {
...
export const buildTurnoverContext = (
...
export const resolveTurnoverForMonth = (
  ...
  if (inputs.turnoverValue <= 0 || !ctx.activeTimelineKeySet.has(monthKey) || ctx.activeCount === 0)
    return 0;
